...
;(function(){
  ...
  var F = knit.algebra.Unnest = function(relation, nestedAttribute) {
  ...
  knit.dslLocals.unnest = function(relation, nestedAttribute) { return new F(relation, nestedAttribute) }

})()

;(function(){

  var F = knit.algebra.Nest = function(relation, nestedAttributeNameAndAttributesToNest) {
    this.relation = relation
  ...
  knit.dslLocals.nest = function(relation, nestedAttributeNameAndAttributesToNest) {
    return new F(relation, nestedAttributeNameAndAttributesToNest)
  }
