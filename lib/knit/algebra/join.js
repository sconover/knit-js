...
knit.algebra.NaturalJoin = function(relationOne, relationTwo) {
  ...
  join.perform = function() {
    var commonAttributeNames = knit._.intersect(this.relationOne.attributes().names(), 
                                                this.relationTwo.attributes().names())
    var commonIdAttributeNames = knit._.select(commonAttributeNames, function(attributeName){return attributeName.match(/Id$/)})
