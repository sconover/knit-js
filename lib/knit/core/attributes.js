knit.Attributes = function() {
  ...
  p.fullyQualifiedNames = function(){return _O.map(this, function(attr){return attr.sourceRelation().name() + "." + attr.name()})}
  ...
  p.getAll = function(arrayOfNames) {
    return _O.select(this, function(attr){return _.include(arrayOfNames, attr.name())})
  }
