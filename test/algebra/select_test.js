...
regarding("select", function() {
  ...
  regarding("sameness and equivalence", function() {
    ...
    test("same - simple", function(){this.$K(function(){ resolve()
    ...
    test("commutativity - order of selects doesn't matter (effectively a conjunction)", function(){this.$K(function(){ 
      resolve()
    ...
    test("split selects are equivalent", function(){this.$K(function(){ 
      resolve()
  ...
  regarding("merging and splitting", function() {
    ...
    test("split a fully split selection, does nothing", function(){this.$K(function(){
      resolve()
  ...
  regarding("selection pushing - basic", function() {
    ...
    test("a selection can be pushed inside a join if the select contains only primitives " +
         "and attributes of one of the relations in the join", function(){this.$K(function(){ 
      resolve()
    ...
    test("selects that have attributes from each join can't be pushed (bounce!)", function(){this.$K(function(){ 
      resolve()
    ...
    test("can't push into a non-join", function(){this.$K(function(){ 
      resolve()
  ...
  regarding("selection pushing - deeper join", function() {
    ...
    test("keep pushing into nested joins", function(){this.$K(function(){ 
      resolve()
  ...
  regarding("selection pushing - deep selects", function() {
    ...
    test("push through layers of selects", function(){this.$K(function(){ 
      resolve()
  ...
  regarding("selection pushing - a selection becomes a join predicate when there's " + 
    ...
    test("push into the join, select disappears", function(){this.$K(function(){ 
      resolve()
    ...
    test("complex select pushes as well", function(){this.$K(function(){ 
      resolve()
    ...
    test("two selects push in and become a conjunction", function(){this.$K(function(){ 
      resolve()
    ...
    test("won't merge if there are attributes from other relations", function(){this.$K(function(){ 
      resolve()
