knit.engine.Memory.Relation = function() {
  ...
  F.prototype.applySelect = function(criteria) {
  ...
  F.prototype.applyProject = function(attributes) {
    var self = this
  ...
  F.prototype.applyJoin = function(relationTwo, predicate) {
    var rows = this.rows()
  ...
  F.prototype.applyOrder = function(orderAttribute, direction) {
  ...
  F.prototype.applyUnnest = function(nestedAttribute) {
  ...
  F.prototype.applyNest = function(nestedAttribute, newAttributeArrangement) {
