knit.RelationReference = function(){
  ...
  _.each(["id", "attributes", "attr", "inspect", "merge", "split", "cost",
          "newNestedAttribute", "perform", "defaultCompiler", "rows", "name", "compile"], function(methodNameToDelegate) {
...
knit.UnresolvedNestedAttributeReference = function(){
  var _ = knit._util,
      F = function(attributeName, nestedAttributes) {
            this._attributeName = attributeName
