...
knit.algebra.Divide = function(){
  ...
  p.perform = function() {
    ...
    var quotientAttributes = this.attributes()
    var dividendAttributesWithDivisorAttributesFirst = this.divisor.attributes().concat(quotientAttributes)
    var orderedDividend = dividendAttributesWithDivisorAttributesFirst.wrapWithOrderBy(this.dividend, knit.algebra.Order.ASC)
    var orderedDivisor = this.divisor.attributes().wrapWithOrderBy(this.divisor, knit.algebra.Order.ASC)
