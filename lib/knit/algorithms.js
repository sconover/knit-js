...
knit.algorithms = (function(){
  ...
  function divide(relation, divisor) {
    var quotientAttributes = _.differ(relation.attributes, divisor.attributes),
        quotientRows = divideRows(relation.attributes, relation.rows, 
                                  divisor.attributes, divisor.rows,
                                  quotientAttributes)
    return {attributes:quotientAttributes, rows:quotientRows}
  }
