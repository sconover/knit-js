...
;(function(){
  ...
  _.extend(this.Select.prototype, _.extend({
    apply: function() {
      return this.relation.apply().applySelect(this.criteria)
    }
  }, rowsAndObjects))

  _.extend(this.Project.prototype, _.extend({
    apply: function() {
      return this.relation.apply().applyProject(this.attributes())
    }
  }, rowsAndObjects))

  _.extend(this.Join.prototype, _.extend({
    apply: function() {
