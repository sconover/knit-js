...
knit.algebra.NaturalJoin = function(relationOne, relationTwo) {
  ...
  join.perform = function() {
    var relationOneAttributeNames = this.relationOne.attributes().map(function(attr){return attr.name()})
    var relationTwoAttributeNames = this.relationTwo.attributes().map(function(attr){return attr.name()})
