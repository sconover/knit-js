...
knit.algebra.predicate.Equality = function() {
  ...
  p._attributesFromRelations = function(relations) {
    var allAttributes = new knit.algebra.Attributes([])
  ...
  p.concernedWithNoOtherRelationsBesides = function() {
    ...
    var expectedExclusiveRelationAttributes = _.flatten(_.map(expectedExclusiveRelations, function(r){return r.attributes().toArray()}))
