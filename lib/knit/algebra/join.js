...
knit.algebra.NaturalJoin = function(relationOne, relationTwo) {
  var _ = knit._util,
      join = new knit.algebra.Join(relationOne, relationTwo, new knit.algebra.predicate.True())

  join.operationName = function(){return "naturalJoin"}
  join.perform = function() {
    var commonAttributeNames = _.intersect(this.relationOne.attributes().names(), 
