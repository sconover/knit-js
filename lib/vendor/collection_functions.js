  ...
  var mainFunction = function(
    ...
    var factory = (function me(
      ...
      function include(collection, findMe) {
        return indexOf(collection, findMe) != __nothing()
      }
      
      function uniq(collection) {
        var newCollection = __newCollection()
        each(collection, function(item){
          if (!include(newCollection, item)) __append(newCollection, item)
        })
        return newCollection
      }
      ...
      function without(collection, dontWantThisItem) {
        return select(collection, function(item) {
          return !__equals(item, dontWantThisItem)
        })
      }
      ...
      function remove(collection, indexWeDontWant) {
        var newCollection = __newCollection()
        each(collection, function(item,i) {
          if (i!=indexWeDontWant) __append(newCollection, item)
        })
        return newCollection
      }
