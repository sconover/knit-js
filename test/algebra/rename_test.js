...
regarding("rename", function() {
  ...
  // test("you can rename a relation", function(){this.$R(function(){
  //   assert.equal("martian", rename(relation("person"), "martian").name())
  // })})

  test("you can rename an attribute", function(){this.$R(function(){
    assert.equal("oldness", rename(attr("person.age"), "oldness").name())
  })})

  test("renamed relations and attributes keep type", function(){this.$R(function(){   
  ...
  regarding("rename relation: sameness and equivalence", function() {
    ...
    test("same if rename name and the relation are equal", function(){this.$R(function(){
  ...
  regarding("rename attribute: sameness and equivalence", function() {
    ...
    test("same if rename name and the attribute are equal", function(){this.$R(function(){
