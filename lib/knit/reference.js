  ...
  knit.ReferenceEnvironment = function(){
    ...
    p.attr = function() {
      ...
      if (args.length == 1) {
        ...
        return knit.bind(regularAttr, this)(relationNameDotAttributeName)
      } else if (args.length==2 && _.isArray(args[1]) ){
        var attributeName = args[0]
        var nestedAttributeRefs = args[1]
        return knit.bind(nestedAttr, this)(attributeName, nestedAttributeRefs)
      } else {
        var self = this
    ...
    p.decorate = function(target, bindings) {
      target.relation = knit.bind(this.relation, this)
      target.attr = knit.bind(this.attr, this)
      var resolveF = knit.bind(this.resolve, this)
