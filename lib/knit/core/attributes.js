knit.Attributes = function() {
  ...
  p.fromPrimitives = function(attrNamePrimitives) {
    ...
    return _O.select(this, function(attr){
      return _.include(flattenedAttrNamePrimitives, attr.name()) || 
             _.include(flattenedAttrNamePrimitives, attr.fullyQualifiedName())
    }) 
  }
