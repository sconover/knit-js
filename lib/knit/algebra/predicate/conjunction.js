...
module.exports.Conjunction = (function(){
  
  var C = function(leftPredicate, rightPredicate) {
  ...
  C.dslLocals = {conjunction: function(leftPredicate, rightPredicate) {
    return new C(leftPredicate, rightPredicate)
  }}
  
  C.dslLocals.and = C.dslLocals.conjunction
