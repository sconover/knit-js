...
knit.algebra.Select = function() {
  ...
  var F = function(relation, predicate) {
  ...
  p.perform = function() { return this.relation.perform().performSelect(this.predicate) }
  ...
  p.merge = function() {
    if (this.relation.predicate) {
      return new F(this.relation.relation.merge(), new knit.algebra.predicate.Conjunction(this.relation.predicate, this.predicate))
    } else {
      return this
    }
  }
  ...
  p.split = function() {
    if (this.predicate.constructor == knit.algebra.predicate.Conjunction) {
        return new F(
          new F(this.relation.split(), this.predicate.leftPredicate),
  ...
  p._doPush = function(relation) { return new F(relation, this.predicate).push() }
